...
dataset_list = ['Kvasir','CVC-ColonDB','CVC-300','CVC-ClinicDB','ETIS-LaribPolypDB'] 
...
for dataset in dataset_list:    
    ...
    for name in name_list: 
        img_list = []
        for i in range(1):
            img_root = os.path.join('/home/hoang/Downloads/ecetest/medi28/28_epoch_0/{}'.format( dataset), name) 
